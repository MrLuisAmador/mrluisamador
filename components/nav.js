               ...
               <ul className="mt-4 mb-4 text-center border-t-[1px] border-t-[#ddd] border-b-[1px] border-b-[#ddd] pt-5 pb-5 lg:pt-0 lg:border-none">
                 <li className="mb-3.5">
                   <Link className="block" href="/" aria-label="Home">
                     <span className="lg:hidden"><HomeIcon className="w-10 h-10 inline" /></span>
                  ...
                  <li className="mb-3.5">
                     <Link className="block" href="/about" aria-label="About Me">
                           <span className="lg:hidden"><UserIcon className="w-10 h-10 inline" /></span>
                  ...
                  <li className="mb-3.5">
                     <Link className="block" href="/skills" aria-label="Skills">
                           <span className="lg:hidden"><InformationCircleIcon className="w-10 h-10 inline" /></span>
                  ...
                  <li className="mb-3.5">
                     <Link className="block" href="/projects" aria-label="Projects">
                           <span className="lg:hidden"><WrenchIcon className="w-10 h-10 inline" /></span>
                  ...
                  <li className="mb-3.5">
                     <Link className="block" href="/case-study" aria-label="Blog">
                           <span className="lg:hidden"><CommandLineIcon className="w-10 h-10 inline" /></span>
                  ...
                  <li className="mb-3.5">
                     <Link className="block" href="/blog" aria-label="Blog">
                           <span className="lg:hidden"><BriefcaseIcon className="w-10 h-10 inline" /></span>
                  ...
                  <li className="">
                     <Link className="block" href="/contact" aria-label="Contact Me">
                           <span className="lg:hidden"><EnvelopeIcon className="w-10 h-10 inline" /></span>
               ...
               <div className="mb-4">
                  <ul className="lg:flex lg:justify-center">
                     <li className="lg:mr-2.5 mb-2.5 lg:mb-0 text-center">
                        <Link className="block transition-colors hover:text-linkedin-blue" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/mrluisamador" aria-label="LinkedIn">
                     ...
                     <li className="lg:mr-2.5 mb-2.5 lg:mb-0  text-center">
                        <Link className="block transition-colors hover:text-twitter-blue" target="_blank" rel="noopener noreferrer" href="https://twitter.com/LinuxLue" aria-label="Twitter">
                           <svg className="w-10 h-10 inline" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                     ...
                     <li className="text-center">
                        <Link className="block transition-colors hover:text-github-orange" target="_blank" rel="noopener noreferrer" href="https://github.com/MrLuisAmador" aria-label="Github">
                           <svg className="w-10 h-10 inline" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
